        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="http://hotspot.wiswaweb.com">Login</a></li>
                    <li class="active"><a href="http://hotspot.wiswaweb.com/status">Status</a></li>
        ...
        <div class="col-md-6 col-sm-12">        
            <div class="row">
                ...
                <?php if($loginby == 'trial') : ?> 
                    <div class="alert alert-info">Selamat Datang Juragan!</div>
                <?php elseif($loginby != 'mac') : ?>    
                    <div class="alert alert-info">Selamat Datang <?php echo $username; ?>!</div>
                <?php endif; ?>
            </div>        
            <div class="row">

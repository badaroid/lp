    ...
    <div class="container">
        <div class="col-md-6 col-sm-12">
            ...
            <div class="row">
                ...
                <div class="alert alert-info">Silahkan masuk untuk menggunaka WiFi</div>
                <?php if($trial == 'yes') : ?> 
                    <div class="alert alert-info">
                        Coba Gratis, <a href="<?php echo $linkloginonly; ?>?dst=<?php echo $linkorigesc; ?>&amp;username=T-<?php echo $macesc; ?>">Klik Disini</a>.
                    </div>
                <?php endif; ?>
            </div>
